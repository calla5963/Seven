...
user_key = "CWB-6C68397A-8921-4160-8CAF-31A738F4416F"
...
def sendLUIS(event, mtext):  #LUIS
    try:                    
        r = requests.get('https://australiaeast.api.cognitive.microsoft.com/luis/prediction/v3.0/apps/3893d8ad-ce77-4b02-9006-80bf927b2612/slots/production/predict?verbose=true&show-all-intents=true&log=true&subscription-key=0b2158079c4347118c792a89a9e33ba5&query=' + mtext)
        result = r.json()
        city = ''
        money = ''
